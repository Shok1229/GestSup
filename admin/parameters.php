				...
				<form enctype="multipart/form-data" method="post" action="">
					<div class="profile-user-info profile-user-info-striped">
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<span id="username">
									<label for="server_url">URL d'accès au serveur: </label>
										<input type="text" name="server_url" value="<?php echo $rparameters['server_url']; ?>">
										<i title="URL de l'accès au serveur pour vos utilisateurs, utilisé dans l'envoi de mail (exemple: http://gestsup en LAN ou  http://support.masociete.com sur Internet" class="icon-question-sign blue bigger-110"></i>
								</span>
							</div>
						</div>
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<span id="username">
									...
									<div class="space-4"></div>
									&nbsp;&nbsp;&nbsp;&nbsp;Ticket ancien : <input name="lign_yellow" type="text" value="<?php echo $rparameters['lign_yellow']; ?>" size="1" /> jours 
									<i title="Détermine, la couleur jaune des tickets dans les tâches"  class="icon-question-sign blue bigger-110"></i><br />
									&nbsp;&nbsp;&nbsp;&nbsp;Ticket très ancien : <input name="lign_orange" type="text" value="<?php echo $rparameters['lign_orange']; ?>" size="1" /> jours 
									<i title="Détermine, la couleur orange des tickets dans les tâches"  class="icon-question-sign blue bigger-110"></i><br />
									&nbsp;&nbsp;&nbsp;&nbsp;Temps d'affichage des messages d'actions : <input name="time_display_msg" type="text" value="<?php echo $rparameters['time_display_msg']; ?>" size="4" /> ms<br />
									&nbsp;&nbsp;&nbsp;&nbsp;Actualisation automatique : <input name="auto_refresh" type="text" value="<?php echo $rparameters['auto_refresh']; ?>" size="3" /> s 
							...
							<div class="profile-info-value">
								...
								if ($rparameters['mail']==1) 
								{
									...
									';
										...
										echo "
											<div class=\"space-4\"></div>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Utilisateur: <input name=\"mail_username\" type=\"text\" value=\"$rparameters[mail_username]\" size=\"30\" />
											<div class=\"space-4\"></div>
