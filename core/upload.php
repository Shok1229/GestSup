...
$file1_rename = utf8_decode($file1_rename);
$file2_rename = utf8_decode($file2_rename);
$file3_rename = utf8_decode($file3_rename);
$file4_rename = utf8_decode($file4_rename);
$file5_rename = utf8_decode($file5_rename);

$a='àáâäçèéêëîï';
$b='aaaaceeeeii';

$file1_rename = strtr($file1_rename,utf8_decode($a), $b);
$file2_rename = strtr($file2_rename,utf8_decode($a), $b);
$file3_rename = strtr($file3_rename,utf8_decode($a), $b);
$file4_rename = strtr($file4_rename,utf8_decode($a), $b);
$file5_rename = strtr($file5_rename,utf8_decode($a), $b);
